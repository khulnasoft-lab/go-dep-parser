...
import "github.com/khulnasoft/go-dep-parser/pkg/types"

var (
	// execute go mod tidy in normal folder
	GoModNormal = []types.Library{
		{Name: "github.com/khulnasoft/go-dep-parser", Version: "0.0.0-20211224170007-df43bca6b6ff", Indirect: false},
	...
	GoModReplaced = []types.Library{
		{Name: "github.com/khulnasoft/go-dep-parser", Version: "0.0.0-20220406074731-71021a481237", Indirect: false},
		{Name: "golang.org/x/xerrors", Version: "0.0.0-20200804184101-5ec99f83aff1", Indirect: true},
	}
